              ...
              <div className="space-y-2 text-xs">
                ...
                {(draft.areaBased.royaltyAmountBeforeVat ?? 0) > 0 && (
                  <div className="mt-2 p-3 rounded-lg bg-emerald-50 border border-emerald-200">
                    <div className="space-y-1">
                      <div className="flex justify-between">
                        <span className="text-zinc-600 text-[11px]">Trước VAT</span>
                        <span className="font-mono tabular-nums text-[11px]">
                          {(draft.areaBased.royaltyAmountBeforeVat ?? 0).toLocaleString('vi-VN')} đ
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-zinc-600 text-[11px]">VAT ({draft.areaBased.vatRate ?? 0}%)</span>
                        <span className="font-mono tabular-nums text-[11px]">
                    ...
                    <div className="mt-2 pt-2 border-t border-emerald-200 flex justify-between items-center">
                      ...
                      <span className="font-mono font-bold text-emerald-800 tabular-nums text-[20px] leading-none">
