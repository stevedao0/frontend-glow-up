...
export function MetricCard({
  ...
  const ringClass = ring
    ? ring === 'rose' ? 'ring-2 ring-rose-400/40'
    : ring === 'emerald' ? 'ring-2 ring-emerald-400/40'
    : ring === 'amber' ? 'ring-2 ring-amber-400/40'
  ...
  return (
    <Tag
      ...
      className={`ds-card group relative rounded-2xl overflow-hidden p-[var(--card-padding)] min-h-[130px] ${ringClass} ${mutedClass} ${interactive ? 'cursor-pointer text-left w-full ds-focus-ring' : ''}`}>
      <div
        aria-hidden
