  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className={`w-full ${h} ${text} pl-9 pr-${kbd ? 14 : 3} rounded-lg bg-white/70 text-zinc-900 placeholder:text-zinc-400 ring-1 ring-zinc-200 hover:ring-zinc-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/40 transition-all`} />
